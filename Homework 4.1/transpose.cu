 ...
 * run: transpose <FILE PATH> <IMAGE WIDTH> <IMAGE HEIGHT>
 *
...
int main(int argc, char* argv[]) {
    ...
    printf("Effective Global Bandwidth (GB/s): %f\n", (width * height * 6) / (averageMsGlobal * 1e6)); // When I ran it, I got 0.56 GB/s
    printf("Effective Tiled Bandwidth (GB/s):  %f\n", (width * height * 6) / (averageMsTiled  * 1e6)); // When I ran it, I got 4.01 GB/s
